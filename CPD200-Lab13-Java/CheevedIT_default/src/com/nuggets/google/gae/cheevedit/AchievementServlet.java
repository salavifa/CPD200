...
public class AchievementServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		// GET from anchor tag to /achievement?action=liked
		if (req.getParameter("action").equals("liked")) {
			
			AchievementOps.likeAchievement(req.getParameter("id"), 
					userService.getCurrentUser().getEmail());
			
			log.info("liked achievement " + req.getParameter("id"));
		}
		
		// GET from anchor tag to /achievement?action=cheeved
		if (req.getParameter("action").equals("cheeved")) {
			
			AchievementOps.completeAchievement(req.getParameter("id"), 
					userService.getCurrentUser().getEmail());
			
			log.info("cheeved achievement " + req.getParameter("id"));
		}	
